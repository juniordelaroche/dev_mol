    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo base_url() ?>cCiudad"><i class="fa fa-circle-o"></i> Registrar ciudad</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
      ...
      <li>
        <a href="<?php echo base_url() ?>cUpload">
          <i class="fa  fa-file-photo-o"></i> <span>Subir imagen</span>
          <span class="pull-right-container">
      ...
      <li>
        <a href="#">
          <i class="fa  fa-envelope"></i> <span>Enviar Correo</span>
          <span class="pull-right-container">
            <small class="label pull-right bg-green">new</small>
          </span>
        </a>
