<?php 
  /*if (!$this->session->userdata('sess_idusuario')) {
    redirect('cLogin');
  }*/
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Codeigniter | Dashboard</title>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url()?>cLogin/cerrarSesion" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
