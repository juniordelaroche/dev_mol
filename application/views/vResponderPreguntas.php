...
<!DOCTYPE html>
 ...
 <head>
   ...
   <title>Codeigniter | Responder preguntas</title>
...
<div class="login-box">
  <div class="login-logo">
    <b>Responder</b>Preguntas
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Responda las preguntas de desafio</p>

    <form action="<?php echo base_url() ?>cUsuario/datosUsuario" method="POST">
     
      <!-- PREGUNTAS DE DESAFIO -->
      <label for="">Primera pregunta</label>
      <div class="form-group has-feedback preguntasDesafio">
        <label for=""><?php echo $p1; ?></label>
      </div>
...
<?php if($this->uri->segment(1)=="cPassword") {?>
